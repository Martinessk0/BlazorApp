...
namespace FileUpload.Services
{
    ...
    public class FileUpld : IFileUpload
    {
        private IWebHostEnvironment _webHostEnvironment;
        private readonly ILogger<FileUpld> _logger;
        public FileUpld(IWebHostEnvironment webHostEnvironment, ILogger<FileUpld> logger)
        {
